...
wp_enqueue_script( 'babylon-oimo', esc_url_raw( 'https://preview.babylonjs.com/Oimo.js' ), array(), null, false);
...
<div class="row">
    <div class="label">Choose Babylon JS source (Local / CDN / Preview)  --#### DOESNT WORK ATM</div>
    <div class="fields">
...
<div class="row">
    <div class="label">Check what do you need  --#### DOESNT WORK ATM</div>
    <div class="fields">
...
function babylonpressCMB_WRAP_' . $canvasid . ' () {
...
BABYLON.DefaultLoadingScreen.prototype.displayLoadingUI = function () {
    ...
    imgBack.src = "http://matest.local/wp-content/uploads/2020/12/logo-babilonpress-FIN-180x106-1.png";
...
/*
$babegin2 = 'renderCanvas-'.$canvasid;
echo $babegin2;

$babegin = $babegin . $babegin2 . '.addEventListener("wheel", evt => evt.preventDefault());';
...
} // END babylonpressCMB_WRAP function

babylonpressCMB_WRAP_' . $canvasid . '();
    </script>';
...
$pglogo = '<img class="pglogo" style="width: 90px;margin-left:-15px;" src="'. $pglogo . '">';
